...
if ([string]::IsNullOrWhiteSpace($Exe)) {
  throw "llama.cpp Windows Manager executable not found. Run .\publish-app.ps1 after installing the .NET 8 SDK."
}
