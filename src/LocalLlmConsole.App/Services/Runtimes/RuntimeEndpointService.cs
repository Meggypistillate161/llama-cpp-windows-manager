...
public static class RuntimeEndpointService
{
    ...
    public static string EndpointDisplay(AppSettings settings)
    {
        ...
        if (!AppPreferenceService.DirectModelsAllowLanAccess(settings.ModelAccessMode)) return local;
    ...
    public static string GatewayEndpointDisplay(AppSettings settings)
    {
        ...
        if (!AppPreferenceService.GatewayAllowsLanAccess(settings.ModelAccessMode)) return local;
